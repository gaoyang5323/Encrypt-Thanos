package com.kakuiwong.service.sortSignService.impl;
 ...
 */
public class SortSignEncryptHandlerImpl implements SortSignEncryptHandler {
    @Override
    ...
    private void checkParam(Object sign, Object timestamp, long timeout, TimeUnit timeUnit) {
        ...
        if (!((now < timestampLong + timeout) && now >= timestampLong)) {
            throw new EncryptException("Illegal request,request timeout");
        }
    }
